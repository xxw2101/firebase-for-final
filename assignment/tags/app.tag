<app>
	...
	<div class="wrap">
		...
		<input type="text" onkeypress={typeWords} placeholder="Please leave your comment" class="textInput">
		<br>
		<br>
	...
	<script>
		var that = this;
		this.todoItems = [{
			name: "Customer Review One",
			done: false
		},{
			name: "Customer Review Two",
			done: false
		}];
